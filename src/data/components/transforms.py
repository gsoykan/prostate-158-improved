...
from src.data.components.transform_config import Config
...
def get_train_transforms(config: Config):
    ...
    if 'rand_bias_field' in config.transforms.__dict__.keys():
    ...
    if 'rand_gaussian_smooth' in config.transforms.__dict__.keys():
    ...
    if 'rand_gibbs_nose' in config.transforms.__dict__.keys():
    ...
    if 'rand_affine' in config.transforms.__dict__.keys():
    ...
    if 'rand_rotate90' in config.transforms.__dict__.keys():
    ...
    if 'rand_rotate' in config.transforms.__dict__.keys():
    ...
    if 'rand_elastic' in config.transforms.__dict__.keys():
        if config.ndim == 3:
    ...
    if 'rand_zoom' in config.transforms.__dict__.keys():
    ...
    if ('rand_crop_pos_neg_label' in config.transforms.__dict__.keys()
            and config.transforms.rand_crop_pos_neg_label is not None):
    ...
    elif 'rand_spatial_crop_samples' in config.transforms.__dict__.keys():
    ...
    if 'gaussian_noise' in config.transforms.__dict__.keys():
    ...
    if 'shift_intensity' in config.transforms.__dict__.keys():
    ...
    if 'gaussian_sharpen' in config.transforms.__dict__.keys():
    ...
    if 'adjust_contrast' in config.transforms.__dict__.keys():
